...
import 'package:weather_status_app/features/weather_status/presentation/manager/search_city_cubit/search_city_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) {
        return SearchCityCubit(getIt.get<GetWeatherStatusRepoImpl>());
      },
      child: Scaffold(
