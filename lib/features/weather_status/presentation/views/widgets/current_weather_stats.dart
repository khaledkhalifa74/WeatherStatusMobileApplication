...
class CurrentWeatherStats extends StatelessWidget {
  ...
  const CurrentWeatherStats({super.key, required this.temp, required this.weatherState, required this.humidity, required this.wind, required this.visibility});
      ...
      child: Column(
        children: [
          Center(
            child: Column(
              children: [
                Icon(Icons.wb_sunny, size: 120, color: Colors.amber.shade300),
